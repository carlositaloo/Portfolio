...
idatendimento = "1498890"
ticket = "107378"
etapa = "avaliação de documentos"
...
img12 = aguardar_imagem('img\\img12.png')
if img12:  # Se achou a imagem
    x, y = pyautogui.center(img12)  # pega o centro
    pyautogui.click(x, y + 30, duration=0.15)  # clica 100px abaixo
    pyautogui.hotkey('ctrl', 'c')
    time.sleep(0.2)  # espera o SO processar o comando
    paste = pyperclip.paste()

pyautogui.click(527, 52, duration=0.15)
time.sleep(1)
pyautogui.click(796, 472, duration=0.15)
time.sleep(1)
pyautogui.click(1156, 683, duration=0.15)
time.sleep(1)
pyautogui.click(1156, 683, duration=0.15)
time.sleep(1)
pyautogui.click(990, 392, duration=0.15)
time.sleep(1)
pyautogui.press('1')
pyautogui.press('tab')
pyautogui.press('tab')
