...
if not aguardar_imagem('img\\esperarAluno.png', timeout=5, continuar=True):
    clicar(aguardar_imagem('img\\aluno.png'))  # ALUNO
if aguardar_imagem('img\\esperarAluno.png', timeout=5, continuar=True):
    clicar(aguardar_imagem('img\\anexos.png'))  # ANEXOS
while not aguardar_imagem('img\\consultaSQL.png', timeout=1.5, continuar=True):
    atalho((['ctrl', 'a']))
